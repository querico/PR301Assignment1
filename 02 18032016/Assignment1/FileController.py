    ...
    def do_chart(self, command):
        try:
            if command != "Age" and command !="Gender" and command !="BMI":
                ...
                module2D = disPlay2D
                module2D.displayAgeGroupIncome()
                print("the Pie Chart has been displayed ")
            elif command == "Gender":
                module2D = disPlay2D
                module2D.displayIncomeByGender()
                print("the Pie Chart has been displayed ")
            elif command=="BMI":
                module2D = disPlay2D
                module2D.displayBMIIncome()
