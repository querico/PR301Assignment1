...
class Validation (object):
    def __init__(self, theFile=None, length=None):
        ...
        readData = ReadData()
        self.theFile  =readData.personal
    ...
    def fileValidation(self):
        for element in range(0, self.length):
            if re.match(r'[A-Z][0-9]{3}', self.theFile[element][0]):
                ...
                'is incorrect ID, Please enter the Correct ID which content, '
                'a capital letter fellow by 3 digits  --->')
                self.theFile[element][0] = newID
        ...
        for element in range(0, self.length):
            ...
            self.theFile[element][1] == "M":
                ...
                " " + 'is incorrect Gender, Please enter the Correct Gender,'
        ...
        for element in range(0, self.length):
            if re.match(r'[0-9]{2}', self.theFile[element][2]):
                ...
                ' is incorrect Age, Please enter the Correct Age, 00 - 99 --->')
        ...
        for element in range(0, self.length):
            if re.match(r'[0-9]{3}', self.theFile[element][3]):
                ...
                " " + "is incorrect Sales, please Enter a correct number"
                " between 000 - 999 --->")
